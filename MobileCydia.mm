...
static NSString *VerifySource(NSString *href) {
    ...
    if (!href_r(href) || [href rangeOfString:@"bingner" options:NSCaseInsensitiveSearch].location != NSNotFound || [href rangeOfString:@"chimera" options:NSCaseInsensitiveSearch].location != NSNotFound) {
        [[[[UIAlertView alloc]
